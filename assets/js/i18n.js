(function () {
  ...
  const translations = {
    en: {
      ...
      "storm.band": "Storm damage? Call about tree service availability",
      "storm.call": "Call (815) 501-1478",
      "storm.page": "Emergency tree help",
      "hero.ringTag": "Every ring, a season",
      "year.month.0.full": "January",
      "year.month.0": "Jan",
      "year.month.1.full": "February",
      "year.month.1": "Feb",
      "year.month.2.full": "March",
      "year.month.2": "Mar",
      "year.month.3.full": "April",
      "year.month.3": "Apr",
      "year.month.4.full": "May",
      "year.month.4": "May",
      "year.month.5.full": "June",
      "year.month.5": "Jun",
      "year.month.6.full": "July",
      "year.month.6": "Jul",
      "year.month.7.full": "August",
      "year.month.7": "Aug",
      "year.month.8.full": "September",
      "year.month.8": "Sep",
      "year.month.9.full": "October",
      "year.month.9": "Oct",
      "year.month.10.full": "November",
      "year.month.10": "Nov",
      "year.month.11.full": "December",
      "year.month.11": "Dec",
      "year.spring.range": "March – May",
      "year.spring.name": "Spring",
      "year.spring.tag": "Wake the yard up.",
      "year.spring.link0": "Spring cleanup",
      "year.spring.link1": "Lawn care",
      "year.spring.link2": "Landscaping",
      "year.spring.link3": "Tree trimming",
      "year.summer.range": "June – August",
      "year.summer.name": "Summer",
      "year.summer.tag": "Keep it growing.",
      "year.summer.link0": "Lawn care",
      "year.summer.link1": "Landscaping",
      "year.summer.link2": "Pressure washing",
      "year.summer.link3": "Storm-damage tree help",
      "year.fall.range": "September – November",
      "year.fall.name": "Fall",
      "year.fall.tag": "Leaves, gutters, and trees.",
      "year.fall.link0": "Leaf removal",
      "year.fall.link1": "Gutter cleaning",
      "year.fall.link2": "Tree removal",
      "year.fall.link3": "Lawn care",
      "year.winter.range": "December – February",
      "year.winter.name": "Winter",
      "year.winter.tag": "Snow and storms.",
      "year.winter.link0": "Snow removal (subject to availability)",
      "year.winter.link1": "Tree removal",
      "year.winter.link2": "Storm-damage tree help",
      "year.label": "The year in the yard",
      "year.heading": "Every season, one crew.",
      "year.intro": "Turn the ring to any month to see what the crew handles then. It opens on this month in DeKalb County.",
      "year.note": "Months are a guide. Call or send a request to ask what fits your yard right now.",
      // Living Seasons + Roots (round 2, 2026-09-23)
      "when.kicker": "Field note",
      "when.title": "When we do this",
      "when.now": "In season now",
      "when.next": "Next in season:",
      "notebook.label": "From the crew's field notebook",
      "trail.sign": "Wrong trail",
      // One walk through the yard (round 3, 2026-09-23)
      "proof.label": "From the job site",
      "strip.photos": "Photos of our work",
      "strip.videos": "Project videos",
      "strip.prevPhotos": "Previous photos",
      "strip.nextPhotos": "Next photos",
      "strip.prevVideos": "Previous videos",
      "strip.nextVideos": "Next videos",
      "quote.chapterLabel": "Your request",
      "quote.chapterHeading": "Tell us about it.",
      "quote.chapterLede": "One request is all it takes. Fill in the form, or call or text if that is easier.",
      "quote.sideLabel": "Other ways to reach us",
      "instant.tag": "Optional",
      "instant.heading2": "Price check: see a starting range",
      "notes.label": "Field notes",
      "year.ringLabel": "Choose a month",
      "year.prev": "Previous month",
      "year.next": "Next month",
      "yard.tree": "The big tree",
      "yard.tree.hint": "Trimming, removal, stumps",
      "yard.lawn": "The lawn",
      "yard.lawn.hint": "Mowing, edging, weeds",
      "yard.beds": "Garden beds",
      "yard.beds.hint": "Mulch, rock, plantings",
      "yard.gutters": "Gutters",
      "yard.gutters.hint": "Clear the roofline",
      "yard.drive": "Driveway & patio",
      "yard.drive.hint": "Pressure washing",
      "yard.leaves": "Fallen leaves",
      "yard.leaves.hint": "Fall and spring cleanup",
      "yard.snow": "Snow on the drive & walks",
      "yard.snow.hint": "Subject to availability",
      "yard.label": "Site plan",
      "yard.heading": "Walk your yard.",
      ...
      "nav.callName": "Call (815) 501-1478",
      ...
      "quote.town.other": "Somewhere else",
      "quote.smsPhotos": "Or text photos of the job to",
      "quote.error.name": "Please enter your name.",
      "quote.error.phone": "Please enter a phone number with at least 10 digits.",
      "quote.error.email": "Please check the email address, or leave it blank.",
      "quote.error.address": "Please enter the property address.",
      "quote.error.verify": "Please confirm you are the owner or an authorized agent.",
      "quote.error.bestTime": "Please choose a callback time.",
      "quote.error.service": "Please choose a service.",
      "quote.error.project": "Please tell us a little about the job.",
      "quote.privacyNote":
    ...
    es: {
      ...
      "year.month.0": "Ene",
      "year.month.1.full": "febrero",
      "year.month.1": "Feb",
      "year.month.2.full": "marzo",
      "year.month.2": "Mar",
      "year.month.3.full": "abril",
      "year.month.3": "Abr",
      "year.month.4.full": "mayo",
      "year.month.4": "May",
      "year.month.5.full": "junio",
      "year.month.5": "Jun",
      "year.month.6.full": "julio",
      "year.month.6": "Jul",
      "year.month.7.full": "agosto",
      "year.month.7": "Ago",
      "year.month.8.full": "septiembre",
      "year.month.8": "Sep",
      "year.month.9.full": "octubre",
      "year.month.9": "Oct",
      "year.month.10.full": "noviembre",
      "year.month.10": "Nov",
      "year.month.11.full": "diciembre",
      "year.month.11": "Dic",
      "year.spring.range": "marzo – mayo",
      "year.spring.name": "Primavera",
      "year.spring.tag": "Despierte su jardín.",
      "year.spring.link0": "Limpieza de primavera",
      "year.spring.link1": "Cuidado del césped",
      "year.spring.link2": "Paisajismo",
      "year.spring.link3": "Poda de árboles",
      "year.summer.range": "junio – agosto",
      "year.summer.name": "Verano",
      "year.summer.tag": "Manténgalo creciendo.",
      "year.summer.link0": "Cuidado del césped",
      "year.summer.link1": "Paisajismo",
      "year.summer.link2": "Lavado a presión",
      "year.summer.link3": "Ayuda con árboles tras tormentas",
      "year.fall.range": "septiembre – noviembre",
      "year.fall.name": "Otoño",
      "year.fall.tag": "Hojas, canaletas y árboles.",
      "year.fall.link0": "Recolección de hojas",
      "year.fall.link1": "Limpieza de canaletas",
      "year.fall.link2": "Remoción de árboles",
      "year.fall.link3": "Cuidado del césped",
      "year.winter.range": "diciembre – febrero",
      "year.winter.name": "Invierno",
      "year.winter.tag": "Nieve y tormentas.",
      "year.winter.link0": "Remoción de nieve (sujeto a disponibilidad)",
      "year.winter.link1": "Remoción de árboles",
      "year.winter.link2": "Ayuda con árboles tras tormentas",
      "year.label": "El año en su jardín",
      "year.heading": "Cada temporada, un solo equipo.",
      "year.intro": "Gire el anillo a cualquier mes para ver qué hace el equipo en esa época. Abre en el mes actual del condado de DeKalb.",
      "year.note": "Los meses son una guía. Llame o envíe una solicitud para saber qué necesita su jardín ahora.",
      // Living Seasons + Roots (round 2, 2026-09-23)
      "when.kicker": "Nota de campo",
      "when.title": "Cuándo lo hacemos",
      "when.now": "En temporada ahora",
      "when.next": "Próxima temporada:",
      "notebook.label": "Del cuaderno de campo del equipo",
      "trail.sign": "Camino equivocado",
      // One walk through the yard (round 3, 2026-09-23)
      "proof.label": "Desde el lugar de trabajo",
      "strip.photos": "Fotos de nuestro trabajo",
      "strip.videos": "Videos de proyectos",
      "strip.prevPhotos": "Fotos anteriores",
      "strip.nextPhotos": "Fotos siguientes",
      "strip.prevVideos": "Videos anteriores",
      "strip.nextVideos": "Videos siguientes",
      "quote.chapterLabel": "Su solicitud",
      "quote.chapterHeading": "Cuéntenos.",
      "quote.chapterLede": "Una sola solicitud es suficiente. Llene el formulario, o llame o envíe un mensaje si le resulta más fácil.",
      "quote.sideLabel": "Otras formas de comunicarse",
      "instant.tag": "Opcional",
      "instant.heading2": "Consulta de precio: vea un rango inicial",
      "notes.label": "Notas de campo",
      "year.ringLabel": "Elija un mes",
      "year.prev": "Mes anterior",
      "year.next": "Mes siguiente",
      "yard.tree": "El árbol grande",
      "yard.tree.hint": "Poda, remoción, tocones",
      "yard.lawn": "El césped",
      "yard.lawn.hint": "Corte, orillado, maleza",
      "yard.beds": "Jardineras",
      "yard.beds.hint": "Mantillo, piedra, plantas",
      "yard.gutters": "Canaletas",
      "yard.gutters.hint": "Limpieza del techo",
      "yard.drive": "Entrada y patio",
      "yard.drive.hint": "Lavado a presión",
      "yard.leaves": "Hojas caídas",
      "yard.leaves.hint": "Limpieza de otoño y primavera",
      "yard.snow": "Nieve en la entrada y banquetas",
      "yard.snow.hint": "Sujeto a disponibilidad",
      "yard.label": "Plano del terreno",
      "yard.heading": "Recorra su jardín.",
      ...
      "nav.callName": "Llamar al (815) 501-1478",
      ...
      "quote.town.other": "En otro lugar",
      "quote.smsPhotos": "O envíe fotos del trabajo por mensaje de texto al",
      "quote.error.name": "Escriba su nombre.",
      "quote.error.phone": "Escriba un número de teléfono de al menos 10 dígitos.",
      "quote.error.email": "Revise el correo electrónico o déjelo en blanco.",
      "quote.error.address": "Escriba la dirección de la propiedad.",
      "quote.error.verify": "Confirme que es el propietario o un agente autorizado.",
      "quote.error.bestTime": "Elija un horario para la llamada.",
