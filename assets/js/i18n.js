(function () {
  ...
  const translations = {
    ...
    es: {
      ...
      "admin.upload.instructions": "Arrastra y suelta tus fotos o selecciónalas desde tu dispositivo.",
      "admin.dropzone.prompt": "Suelta las imágenes aquí o",
      "admin.dropzone.button": "Elegir fotos",
      "admin.file.empty": "No hay fotos seleccionadas todavía.",
      "admin.file.remove": "Quitar",
      "admin.upload.button": "Subir fotos",
      ...
      "admin.message.selectImage": "Selecciona al menos una imagen.",
      "admin.message.uploading": "Subiendo fotos...",
      ...
      "admin.message.uploadSuccess": "¡Listo! Las fotos ya están en la galería.",
      "admin.message.noUploads": "No se subió ninguna imagen.",
      "admin.message.duplicates": "Estas imágenes ya estaban en la lista.",
      "admin.message.skipped": "Solo se permiten archivos de imagen.",
      "admin.message.filesAdded.one": "Se añadió {{count}} foto a la lista.",
      "admin.message.filesAdded.other": "Se añadieron {{count}} fotos a la lista.",
