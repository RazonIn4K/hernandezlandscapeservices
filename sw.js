const CACHE_NAME = 'hernandez-landscape-v44';
...
const URLS_TO_CACHE = [
  '/',
  '/es/',
  '/assets/css/site.css?v=20260924ab',
  '/assets/css/fonts-late.css?v=20260924l',
  '/assets/js/i18n.js?v=20260924aa',
  '/assets/js/main.js?v=20260924aa',
  '/assets/js/rings.js?v=20260924ab',
