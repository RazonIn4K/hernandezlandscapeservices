...
const linked: Array<[string, string, 'es' | 'en', string]> = [
  ...
  // Round 6: these have Spanish twins now.
  ['/gutter-cleaning/', '/es/gutter-cleaning/', 'es', 'Español'],
  ['/service-areas/', '/es/service-areas/', 'es', 'Español'],
  ['/service-areas/dekalb-il/', '/es/service-areas/dekalb-il/', 'es', 'Español'],
